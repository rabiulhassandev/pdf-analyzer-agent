...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Settings::create([
            ...
            'system_instructions' => 'You are a Purchase Order (PO) Extraction Agent specialised in reading and interpreting garment, sportswear, and textile industry purchase order documents.
