            ...
            <form action="{{ route('prompts.store') }}" method="POST" class="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select name="customer_id" class="w-full appearance-none bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-blue-500 transition-colors cursor-pointer">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" required class="w-full bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-blue-500 transition-all" placeholder="e.g., Purchase Order Analysis">
                    </div>

                    <div>
                        <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Status</label>
                        <select name="status" class="w-full appearance-none bg-white border border-slate-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-blue-500 transition-colors cursor-pointer">
                    ...
                    <div>
                        ...
                        <textarea name="content" required rows="12" class="w-full bg-slate-50 border border-slate-200 rounded-lg p-4 text-sm focus:outline-none focus:border-blue-500 transition-all resize-none leading-relaxed" placeholder="Enter the prompt content for AI analysis..."></textarea>
